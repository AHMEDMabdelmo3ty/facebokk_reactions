import 'package:facebook_reaction/fb_reaction_box.dart';
...
class MainApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        backgroundColor: Color.fromARGB(255, 18, 34, 70),
        appBar: AppBar(
          title: Text('MAIN'),
          centerTitle: true,
        ),
...
class MainScreenState extends State<MainScreen> {
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: index == selectedIndex
                  ? Color.fromARGB(255, 31, 91, 219)
                  : Color.fromARGB(255, 173, 155, 109),
      ...
      style: ButtonStyle(
        backgroundColor: MaterialStateProperty.resolveWith<Color>(
          (Set<MaterialState> states) {
            ...
            return Color.fromARGB(255, 25, 98, 255);
          },
        ),
  ...
  Widget build(BuildContext context) {
    return Material(
      color: Color.fromARGB(255, 18, 34, 70),
      child: Center(
          child: Column(
        children: <Widget>[
          Container(
